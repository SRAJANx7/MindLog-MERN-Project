  ...
  return (
    <div className="flex justify-center px-4 sm:px-6 lg:px-10 my-10">
      <div className="w-full max-w-3xl bg-base-200 shadow-xl hover:shadow-2xl rounded-3xl p-6 md:p-8">
        <h1 className="text-3xl font-bold text-center mb-7">About MindLog</h1>
        <p className="text-lg text-center mb-4">
          MindLog is a secure and trusted digital journal that protects your
          thoughts and memories. Built for simplicity and reliability, it allows
          you to document your experiences with ease. MindLog prioritizes
        ...
        <ul className="space-y-3 text-lg px-4 sm:px-6">
          <li className="flex items-start gap-2">
            ...
            <span>
              ...
              edit, and delete MindLog entries while keeping them safe.
            </span>
          </li>
          <li className="flex items-start gap-2">
            <span>📅</span>
          ...
          <li className="flex items-start gap-2">
            <span>🔒</span>
            <span>
              <strong>Advanced Security Features:</strong> Protect your MindLog
        ...
        <p className="text-lg text-center">
          Start your journaling journey with <strong>MindLog</strong> - where
